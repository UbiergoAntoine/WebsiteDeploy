...
$data_ajaxloading     = ( pixelgrade_option( 'use_ajax_loading' ) && ! is_customize_preview() ) ? 'data-ajaxloading' : '';
$data_smoothscrolling = ( pixelgrade_option( 'use_smooth_scroll' ) ) ? 'data-smoothscrolling' : '';
...
if ( ( pixelgrade_option( 'use_ajax_loading' ) ) && ! is_customize_preview() ) {
	global $wp_the_query;
...
if ( pixelgrade_option( 'header_inverse' ) ) {
...
if ( ( ! in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) )
     && pixelgrade_option( 'enable_woocommerce_support' )
) {
...
<div id="page">
	<nav class="navigation  navigation--mobile">
		<h2 class="accessibility"><?php esc_html_e( 'Primary Mobile Navigation', 'lens' ) ?></h2>
