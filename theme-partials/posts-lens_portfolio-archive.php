...
<div id="main" class="content djax-updatable <?php echo $classes; ?>">
	...
	<div class="mosaic <?php echo esc_attr( $mosaic_classes ) ?>" data-maxpages="<?php echo $query->max_num_pages ?>">
		...
		<?php if ( pixelgrade_option( 'portfolio_show_archive_title' ) && $paged == 1 ): ?>
			<div class="mosaic__item <?php echo esc_attr( $thumb_orientation ); ?> mosaic__item--page-title-mobile js--is-loaded <?php echo lens::get_terms_as_string( 'lens_portfolio_categories', 'slug' ); ?>">
					...
					<div class="image__item-meta">
						<div class="image_item-table">
							<div class="image_item-cell">
								<h1><?php esc_html_e( 'Portfolio', 'lens' ) ?></h1>
							</div>
						</div>
					</div>
				</div>
		...
		<?php if ( $query->have_posts() ) :
			...
			while ( $query->have_posts() ) : $query->the_post();
				...
				if ( $idx == 3 && pixelgrade_option( 'portfolio_show_archive_title' ) && $paged == 1 ) : ?>
					<div class="mosaic__item <?php echo esc_attr( $thumb_orientation ); ?> mosaic__item--page-title js--is-loaded <?php echo lens::get_terms_as_string( 'lens_portfolio_categories', 'slug' ); ?>">
						<div class="image__item-link">
							<div class="image__item-wrapper">
								<?php if ( $has_post_thumbnail ) : ?>
									<img
