...
class wpGrade_Archives_Navmenu_Metabox{
     ...
     public function __construct(){
          ...
          add_action('wp_ajax_my-add-post-type-archive-links', array( $this, 'ajax_add_post_type'));
     ...
     public function add_meta_box() {
          add_meta_box( 'post-type-archives', esc_html__('Archives','lens'),array($this,'metabox'),'nav-menus' ,'side','low');
     }
