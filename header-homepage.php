<?php
/**
 * The template for the homepage header.
 *
 * @package Lens
 */
...
//get the option the user chose in the page metaboxes
...
echo ' ' . $data_ajaxloading . ' ' . $data_smoothscrolling . ' ' . $data_currentID . ' ' . $data_currentEditString . ' ' . $data_currentTaxonomy; ?>>
<?php wp_body_open(); ?>
<div class="pace">
